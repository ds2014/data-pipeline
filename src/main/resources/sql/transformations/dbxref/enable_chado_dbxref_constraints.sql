...
ALTER TABLE chado.dbxref ADD CONSTRAINT dbxref_db_id_fkey FOREIGN KEY (db_id) REFERENCES db(db_id) ON DELETE CASCADE DEFERRABLE INITIALLY DEFERRED;
ALTER TABLE chado.dbxref ADD CONSTRAINT dbxref_c1  UNIQUE (db_id, accession, version);
ALTER TABLE dbxref ADD CONSTRAINT dbxref_pkey PRIMARY KEY (dbxref_id);
